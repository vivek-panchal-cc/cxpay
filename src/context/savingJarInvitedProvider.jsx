...
export const SavingJarInvitedContext = React.createContext({});

const SavingJarInvitedProvider = ({ children }) => {
  ...
  return (
    <SavingJarInvitedContext.Provider
      value={{
        pagination,
        listPayments,
        upPaymentEntry,
...
export default SavingJarInvitedProvider;
