...
function ChangePassword() {
  ...
  const [isInputOldPasswordFocused, setIsInputOldPasswordFocused] =
    useState(false);
  ...
  const handleSubmitData = async (pin) => {
    ...
    try {
      ...
      const { data } = await apiRequest.passwordChange(params);
                  ...
                  <div className="form-field">
                    ...
                    <span
                      ...
                      style={{
                        top: "24px",
                        right:
                          isSafari && isInputOldPasswordFocused ? "45px" : "",
                      }}
                    >
                      {showPassword.old ? (
                        <IconEyeOpen
