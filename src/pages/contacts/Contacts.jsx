...
const Contacts = (props) => {
  ...
  const handleDeleteContact = async (contactArray) => {
    try {
      ...
      data["status_code"] === 200 && retrieveContacts();
    ...
    <div className="container-fluid">
      <div className="row">
        <div className="dashboard-top-sec">
          <div className="dashboard-search-wrap col-lg-7 col-12"></div>
            ...
            <div className="contact-top-btn-nav">
              ...
              <div className="con-btn-wrap con-invite-btn-wrap">
                <Modal id="invite_contact" show={show} setShow={setShow}>
                  <InviteContact setShow={setShow} {...{ invitetitle }} />
                </Modal>
                <button
                  className="btn"
                  type="button"
                  ...
                  <li key={contact.id}>
                    ...
                    <div className="cont-listing-last-wrap">
                      <div className="con-listing-edit-wrap">
                        ...
                        {/* <a href="/" className="conlist-edit-a con-list-up">
                          <svg
                            width="20"
                            height="19"
                            viewBox="0 0 20 19"
                          ...
                          >
                            ...
                            ></path>
                            <path
                              d="M14.5166 1.56907C14.9144 1.17125 15.454 0.947754 16.0166 0.947754C16.2952 0.947754 16.571 1.00262 16.8284 1.10923C17.0858 1.21584 17.3196 1.37209 17.5166 1.56907C17.7136 1.76606 17.8698 1.99991 17.9764 2.25728C18.0831 2.51465 18.1379 2.7905 18.1379 3.06907C18.1379 3.34765 18.0831 3.6235 17.9764 3.88087C17.8698 4.13824 17.7136 4.37209 17.5166 4.56907L5.0166 17.0691L1.0166 18.0691L2.0166 14.0691L14.5166 1.56907Z"
                              stroke="#0081C5"
                              stroke-width="1.5"
                              stroke-linecap="round"
                              stroke-linejoin="round"
                        ...
                        <button
                          ...
                          class="conlist-del-a con-list-up"
                        >
                          <svg
                            width="16"
                            height="18"
